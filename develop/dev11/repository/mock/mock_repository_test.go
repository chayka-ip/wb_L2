...
func TestMockRepoCreateEvent_InternalState(t *testing.T) {
	r := New()
	...
	assert.Equal(t, r.storage[userID], []calendar.Event{event})
	event2, err := r.CreateEvent(userID, event)

	assert.NoError(t, err)
	assert.Equal(t, r.storage[userID], []calendar.Event{event, event2})
}

func TestMockRepoCreateEvent(t *testing.T) {
	r := New()
...
func TestMockRepoUpdateEvent(t *testing.T) {
	r := New()
...
func TestMockRepoDeleteEvent(t *testing.T) {
	r := New()
	...
	assert.Equal(t, r.storage[userID], []calendar.Event{})
}
func TestMockRepoGetEvents(t *testing.T) {
